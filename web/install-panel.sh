...
echo ""
echo -e "  ${BOLD}Required flags for nodes:${NC}"
echo -e "    --domain SUB.jetsflare.com   Cloudflare subdomain (Proxied A-record)"
echo ""
echo -e "  ${BOLD}Don't forget in Cloudflare:${NC}"
echo -e "    1. Add A-record for each node subdomain (Proxied)"
echo -e "    2. SSL/TLS mode: Full"
echo ""
echo -e "${BOLD}═══════════════════════════════════════════════════════${NC}"
echo ""
